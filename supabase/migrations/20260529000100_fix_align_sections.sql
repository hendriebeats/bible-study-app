-- ============================================================================
-- Fix align_sections: the target-passage columns are start_verse_id/
-- end_verse_id (only the `my_pass` CTE aliases them sv/ev). The previous body
-- referenced tp.sv/tp.ev, which fails at call time.
-- ============================================================================
